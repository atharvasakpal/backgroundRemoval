      ...
      <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
         ...
         <div className='flex flex-col sm:grid grid-cols-2 gap-8'>
            ...
            {/* -------------_BUTTONS---------- */}
              ...
              <a href={resultImage} download className='px-8 py-2.5 text-white text-sm bg-gradient-to-r  from-violet-700 to-fuchsia-500 rounded-full hover:scale-105 transition-all duration-700'>Download Image</a>
            </div>
            }
