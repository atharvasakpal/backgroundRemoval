...
const Buycredit = () => {
  ...
  return (
    <div className='min-h-[80vh] text-center pt-14 mb-10'>
      ...
      <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-slate-900 to-slate-500 bg-clip-text text-transparent mb-6 sm:mb-10'>Choose the plan that's best for you</h1>
